label garmin:
  python:
    ...
    answers = {
      "FOOD": "Showing nearby restaurants.",
      "HEX": "Showing red light cameras on map.",
      "WORD" : "No results found for 'boatswain' in Edmonton, would you like to expand the search?",
      "TRAVEL" : "Yes!  I know this one!  Head EAST on Yellowhead Highway for FIVE HOURS, then merge onto the I-94 Highway for THIRTY-THREE HOURS...",
      "CONTROL" : "Directing you to nearest Pregnancy Care Center.  Turn RIGHT onto 104 Avenue Northwest.",
    }
    ...
    target = Chat("garmin", 0, crimson, questions, answers, followupQ, followupA)
    target.start()
