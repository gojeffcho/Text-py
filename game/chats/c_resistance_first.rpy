    ...
    while True:
        ...
        if cmd.upper() not in expected:
            ...
            if len(args) == 0:
                ...
                $desc = "You reported a suspicious interaction.  Press {b}ENTER{/b} to return to the main menu."
                $say()
                $flush_input()
            ...
            if len(args) == 0:
                ...
                if q.upper() == "YES" or q.upper() == "NO" or q.upper() == "UNCERTAIN":
                  $desc = "Chat has disconnected.  Press {b}ENTER{/b} to return to the main menu."
                  $say()
